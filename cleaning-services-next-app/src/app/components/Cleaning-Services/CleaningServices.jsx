			...
			<section className="cleaning-services py-5">
				<div className="container">
					...
					<div className="text text-center mb-4">
						<Image src={Figure1} alt="" className="mb-3 h-auto" />
						<h1 className="heading">Cleaning Services</h1>
						<p className="regular-paragraph">
							Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure,
							doloribus. Sunt, perspiciatis! Repudiandae, assumenda
						</p>
					</div>
					{/* <!-- Services Cards --> */}
						...
						<div className="col-12 col-md-6 col-lg-4">
							<div className="card h-100 text-center p-1">
								<Image
									src={Team3}
									alt=""
									className="card-img-top mx-auto h-auto"
								/>
								<div className="card-body">
									...
									<ul className="list-unstyled">
										<li className="mb-2">
											<i className="fa-solid fa-check me-2 p-2"></i>Kitchen
										</li>
										<li className="mb-2">
											<i className="fa-solid fa-check me-2 p-2"></i>Bathroom
										</li>
										<li className="mb-2">
											<i className="fa-solid fa-check me-2 p-2"></i>Bedroom
										</li>
										<li className="mb-2">
											<i className="fa-solid fa-check me-2 p-2"></i>Windows
										</li>
										<li className="mb-2">
											<i className="fa-solid fa-check me-2 p-2"></i>Carpets
										</li>
									</ul>
								</div>
							</div>
