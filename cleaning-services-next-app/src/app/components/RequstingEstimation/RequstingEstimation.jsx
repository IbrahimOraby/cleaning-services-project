					...
					<div className="Wrapper d-flex flex-column flex-lg-row">
						...
						<div className="content w-100 px-lg-5 mb-4 mb-lg-0">
							...
							<p className="regular-paragraph py-2 fs-5">
								...
								quisquam praesentium ratione, cupiditate repudiandae repellendus
								amet laborum quasi, cumque illum, nobis odit consequatur! Ipsa
								et, accusantium nesciunt maxime veritatis amet.
							</p>
							<div className="list mt-4">
								<ul className="list-unstyled">
									<li className="mb-2 py-1">
										<h2 className="sub-heading">
											<i className="fa-solid fa-check me-2 p-2"></i> Customer
											Foucsed Reviews
										</h2>
										<p className="p-2 px-5 mx-3 regular-paragraph">
									...
									<li className="mb-2 py-1">
										<h2 className="sub-heading">
											<i className="fa-solid fa-check me-2 p-2"></i> We Are
											Committed
										</h2>
										<p className="p-2 px-5 mx-3 regular-paragraph">
											Lorem ipsum dolor sit, amet consectetur adipisicing elit.
									...
									<li className="mb-2 py-1">
										<h2 className="sub-heading">
											<i className="fa-solid fa-check me-2 p-2"></i> Regular &
											Monthly Cleaning
										</h2>
										<p className="p-2 px-5 mx-3 regular-paragraph">
											Lorem ipsum dolor sit, amet consectetur adipisicing elit.
						...
						<div className="form w-75 p-5">
							<h1 className="text-center sub-heading mb-4">
								Request An Estimate
							</h1>
							<form action="">
								<div className="mb-3">
								...
								<div className="d-flex Quote p-2 justify-content-center">
									<a
										href="#"
										className="btn d-flex align-items-center fw-bold mx-3"
									>
										{" "}
										Book Now <i className="fa-solid fa-chevron-right p-2 "></i>
									</a>
								</div>
							</form>
						</div>
