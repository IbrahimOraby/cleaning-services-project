					...
					<div className="row">
						...
						<div className="images d-none d-lg-block col-12 col-md-6 mb-4 mb-md-0">
							<div className="image-1">
								<Image src={Team1} alt="" className="w-100" />
							</div>
						...
						<div className="text col-12 col-md-6 d-flex flex-column justify-content-center text-center text-md-start">
							<div className="content">
								...
								<p className="regular-paragraph">
									...
									Iure, doloribus. Sunt, perspiciatis! Repudiandae, assumenda,
									ea, veniam, minus qui molestias delectus veniam ea debitis
									quae architecto ipsum quo illum? Dolore, voluptatibus.
								</p>
								<ul className="list-unstyled mt-3">
									<li className="mb-2">
										<i className="fa-solid fa-check me-2"></i> Remove debris and
										glass
									</li>
									<li className="mb-2">
										<i className="fa-solid fa-check me-2"></i> Clean and polish
										floors and walls
									</li>
									<li className="mb-2">
										<i className="fa-solid fa-check me-2"></i> Apply insulation
										to walls and ceilings
									</li>
									<li className="mb-2">
										<i className="fa-solid fa-check me-2"></i> Remove gutters
										and downspouts
									</li>
									<li className="mb-2">
										<i className="fa-solid fa-check me-2"></i> Fix broken
										appliances
									</li>
								</ul>
							</div>
