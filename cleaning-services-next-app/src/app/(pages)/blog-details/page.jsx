...
import blogDetails from "../../assets/images/Blog/Blogs-card-1.jpg";
									...
									<header>
										...
										<div className="rate d-flex my-3">
											<div className="author d-flex align-items-center">
												<Image src={man1} alt="Author" className="ms-3" />
												<span>By Mark Wily</span>
											</div>
											<div className="likes d-flex align-items-center ms-3">
												<i className="fa-solid fa-heart"></i>
												<span className="text-dark fw-bolder ms-1">
													06 Likes
												</span>
											</div>
									...
									<div className="parts my-5">
										<div className="row d-flex">
											<div className="col-md-6 d-flex">
												<Image src={cleaning1} alt="Previous Post" />
											...
											<div className="col-md-6 d-flex">
												...
												<Image src={cleaning2} alt="Next Post" />
											</div>
										</div>
									</div>
									<div className="mess p-5 rounded my-5">
										...
										<div className="row my-4">
											<div className="col-md-2">
												<Image src={woman2} alt="Commenter" />
											</div>
											<div className="col-md-10">
									...
									<div className="post border p-5 rounded my-4">
										...
										<form action="" className="mt-4">
											...
											<textarea
												...
												required
											></textarea>
											<button type="submit" className="py-3 px-5 mt-3 btn">
												Post Comment
											</button>
										</form>
									</div>
