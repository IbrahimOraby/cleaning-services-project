		...
		<>
				...
				<div className="container">
					<div className="row">
						<div className="col-12 col-md-6 p-5">
							...
							<p>
								Chen 3 kno pris took a gale of pe and scrambled to makes
								me secmen bck ha ved ot re cori bso Below
								kno preter too galley of fe and scrmbie 10 make a ype
								tr bck. hs sed ct ah fe crn.
							</p>
							<div className="d-flex gap-2 mt-4">
								<div><i className="fa-regular fa-circle-check mt-1"></i></div>
								<div>
									<h4>Customer Focused Reviews</h4>
									<p>Aorem ipsum dolor st amet consectetur adipiscing eb sed do
										‘Susmod tempor ncddunt ut soe t dolore.</p>
								</div>
						...
						<div className="col-12 col-md-6 d-flex justify-content-center position-relative p-5">
							<div>
								<img src="./assets/images/cleaning-img.jpg" alt="cleaning person" srcSet="" className="w-100" />
							</div>
						</div>
					</div>
				</div>
				...
				<div className="container d-flex justify-content-center p-5 flex-wrap">
					<div className="col-12 col-lg-4 d-flex justify-content-center align-items-center p-1">
						<div className="features-card text-center p-5">
							...
							<p className="text-white">Ahen an unknown printer took a galley of
								type and scrambled it to make a type
								specimen five centuries. </p>
				...
				<div className="container">
					<div className="row text-center py-5">
						<div className="col-12">
							<img className="working_experts_img img-fluid" src="./assets/images/figure1.png"
							...
							<div className="working_experts_info">
								...
								<p className="mt-2 fs-p regular-paragraph">
									...
									accusantium fa-angle- <br />double-up oremque laudantium, totam
									remeaque ipsa
								</p>
							</div>
						</div>
					...
					<div className="row mt-5 mb-5">
						...
						<div className="col-12 col-sm-6 col-lg-4">
							<div className="card border-0 d-flex align-items-center position-relative">
								<div className="bubble_img w-100 d-none d-lg-block position-absolute">
									<img className="bubble position-absolute h-100" src="./assets/images/bubble1.png"
										alt="bubble1.png" />
								</div>
								<div className="working_experts_image overflow-hidden position-relative rounded-circle">
									<img className="image w-100 h-100 position-absolute z-1" src="./assets/images/team1.png"
										alt="latestBlogImg" />
								</div>
							</div>
							<div className="card-body text-center p-0">
								<h3 className="fw-bold mt-5 heading_primary_blue">Richard Powel</h3>
								<span className="regular-paragraph mt-3">Office Cleaner</span>

								<ul
									className="working_experts_social list-unstyled d-flex align-items-center justify-content-center my-3">
						...
						<div className="col-12 col-sm-6 col-lg-4 mt-sm-0 mt-4">
							...
							<div className="card-body text-center p-0">
								<h3 className="fw-bold mt-5 heading_primary_blue">Merry Patel</h3>
						...
						<div className="col-12 col-sm-6 col-lg-4 mt-lg-0 mt-4">
							...
							<div className="card-body text-center p-0">
								<h3 className="fw-bold mt-5 heading_primary_blue">Johnson Jack</h3>
			...
			<section className="read-more d-flex flex-column flex-md-column flex-lg-row align-items-center">
				<div className="image w-100 w-lg-50 d-flex align-items-center justify-content-center mb-4 mb-md-5">
					<img src="./assets/images/read-more.webp" alt="readMore" className="img-fluid" />
				</div>
				...
				<div className="container">
					<div className="d-flex flex-column align-items-center">
						<div className="col-6 text-center">
							<h3>How It Works</h3>
							<p>Perspiciatis unde omnis iste natus error sit voluptatem accusantium dol oremaque
								laudantium, totam remeaque ipsa</p>
						</div>
						<div className="d-flex justify-content-center align-items-center flex-wrap mt-5">
							<div className="col-12 col-lg-4 d-flex justify-content-center flex-column align-items-center">
								...
								<h5>book online</h5>
								<p>Perspiciatis unde omnis iste natus error sit voluptatem accusantium dolore</p>
							</div>
				...
				<div className="container">
					<div className="d-flex justify-content-center align-items-center flex-wrap">
						<div className="col-12 col-lg-8 my-2 d-flex justify-content-center align-items-center">
							<h3 className="text-white">Get started with your free estimate</h3>
						</div>
						...
						<div className="d-none d-lg-block col-lg-2 d-flex justify-content-center align-items-center">
							<img src="./assets/images/team2.png" alt="cleaning person" className="w-100" />
						</div>
					</div>
				</div>
			</section>
